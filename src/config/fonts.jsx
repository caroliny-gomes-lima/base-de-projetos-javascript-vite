...
const extraBold = '"Montserrat Extrabold", "Helvetica", "Arial", sans-serif';
const medium = '"Montserrat medium", "Helvetica", "Arial", sans-serif';
const roman = '"Montserrat roman", "Helvetica", "Arial", sans-serif';
const italic = '"Montserrat italic", "Helvetica", "Arial", sans-serif';
